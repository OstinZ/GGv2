...
async def main():
    ...
    # Checking for proxy file and prompting if not found
    if not os.path.exists(args.proxy):
        print(f"{red}{args.proxy} not found. Please enter a proxy or leave blank if not needed.")
        proxy = input("Please enter your proxy (or leave blank if none): ")
